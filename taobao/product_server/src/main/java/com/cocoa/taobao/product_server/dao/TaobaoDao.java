...
//
//    PageRequest pageRequest = new PageRequest(finalPage, finalSize, Sort.Direction.DESC, "sales");
...
//
//    Page<CommitItem> mList = taobaoDao.findAll(Example.of(commitItem, matcher), pageRequest);
}
