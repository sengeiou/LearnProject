 ...
 * @FileName: cv.cocoa.com.customerlayout.CustomerLayout.java
 * @author: shenjun@kuaiqiangche.com
 * @date: 2016-03-30 16:50
 */
public class CustomerLayout extends ViewGroup {
    ...
    public CustomerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new CustomerLayout.LayoutParams(getContext(), attrs);
    }
