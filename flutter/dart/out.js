// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.11.0-242.0.dev.
...
(function dartProgram() {
  ...
  D = {
    main: function() {
      var t1, e, prefix, suffix,
        _s9_ = "COCOCA  \n";
      P.print("the name isEmpty is false");
      t1 = C.JSString_methods.trim$0(_s9_);
      P.print(t1);
      P.print("" + C.JSString_methods.endsWith$1(t1, "A"));
      P.print("the name subString 0-3 " + C.JSString_methods.substring$2(_s9_, 0, 3));
      P.print("the name *3 = " + C.JSString_methods.$mul(t1, 3));
      P.print("the name padleft 10 is " + C.JSString_methods.padLeft$2(t1, 10, "A"));
      e = P.RangeError_checkValidRange(0, 2, t1.length);
      prefix = t1.substring(0, 0);
      suffix = t1.substring(e);
      P.print("the name replacerange is " + (prefix + "TTTTT" + suffix));
      P.print("the name to lowercase is " + t1.toLowerCase());
    }
  };
  var holders = [C, H, J, P, D];
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, H.Closure, H.Rti, H._FunctionParameters, P.OutOfMemoryError, P.Null, P.StringBuffer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JSArray, J.JSNumber, J.JSString]);
    _inherit(J.JSUnmodifiableArray, J.JSArray);
    _inheritMany(J.JSNumber, [J.JSInt, J.JSDouble]);
    _inheritMany(P.Error, [H.LateInitializationErrorImpl, H.RuntimeError, H._Error, P.AssertionError, P.NullThrownError, P.ArgumentError, P.UnsupportedError, P.ConcurrentModificationError, P.CyclicInitializationError]);
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JSBool":{"bool":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSDouble":{"num":[]},"JSString":{"String":[]}}'));
  0;
