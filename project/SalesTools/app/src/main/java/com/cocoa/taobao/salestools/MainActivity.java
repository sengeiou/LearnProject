package com.cocoa.taobao.salestools;
...
import com.cocoa.taobao.salestools.commit_bean.CommitItem;
import com.cocoa.taobao.salestools.ding.DingHook;
import com.cocoa.taobao.salestools.resp_bean.RespObj;
import com.cocoa.taobao.salestools.resp_bean.RespTaoItem;
...
//    };
    ...
    static final String url
            = "/product/product/list?pageSize=" + array_length + "&keywords=";
    ...
    public static final String taobaourl = "https://item.taobao.com/item.htm?id=";
    public static final String DD_WEBHOOK_URL = "https://oapi.dingtalk.com/robot/send?access_token=ba895b6c33bc212547af72395d37dd29f246bd337ceab884e63491d8099f2a09";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.clear).
                setOnClickListener(new View.OnClickListener() {
                                       ...
                                       public void onClick(View view) {
                                           logED.setText("");
                                           dingHook("16767959816","12312","11111");
                                       }
                                   }
                ...
                protected Object doInBackground(Object[] params) {
                    try {
                        ...
                        if(Integer.parseInt(msg) > 1000){
                            dingHook(commitItem.getNum_iid(),keywords.getText().toString(),msg);
                        }

                        String url
                                = urlHost + "/product/taobao/insertItem?json=";
...
//    }
    ...
    private void dingHook(final String numiid, final String kewords , final String sales){
//        DingHook
        ...
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(@NonNull ObservableEmitter<String> e) throws Exception {
                ...
                try {
                    ...
                    DingHook hook = new DingHook("find a large sales item!!!","we search "+ kewords +" find sales was "+sales,"",taobaourl+numiid);

                    OkHttpClient client = new OkHttpClient();
                    String jsr =   com.alibaba.fastjson.JSON.toJSONString(hook);
                    RequestBody body = RequestBody.create(JSONMediaType, jsr);
                    Request request = new Request.Builder()
                            .url(DD_WEBHOOK_URL)
                            .post(body)
                            .build();
