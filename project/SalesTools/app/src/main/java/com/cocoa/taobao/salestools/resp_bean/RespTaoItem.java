...
public class RespTaoItem {
    ...
    private RespSmallImage small_images;// {
    ...
    public RespSmallImage getSmall_images() {
        return small_images;
    }

    public void setSmall_images(RespSmallImage small_images) {
