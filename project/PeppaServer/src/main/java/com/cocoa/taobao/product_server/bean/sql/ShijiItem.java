...
public class ShijiItem extends BaseItem {
    ...
    public Object[] sqlParams() {
        return new Object[]{item_url, nick, num_iid, pict_url, provcity, reserve_price, seller_id, small_img, title, user_type, volume, zk_final_price, sales, sales_update_time, createTime, status};
    }
    ...
    public Long getSales_update_time() {
        return sales_update_time;
    }

    public void setSales_update_time(Long sales_update_time) {
    ...
    public int getTb_from() {
        return tb_from;
    }

    public void setTb_from(int tb_from) {
        this.tb_from = tb_from;
    }
}
