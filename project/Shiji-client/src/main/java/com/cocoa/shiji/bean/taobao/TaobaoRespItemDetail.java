...
public class TaobaoRespItemDetail {
    ...
    private TaobaoSmallimg small_images ;// {
    ...
    public TaobaoSmallimg getSmall_images() {
        return small_images;
    }

    public void setSmall_images(TaobaoSmallimg small_images) {
